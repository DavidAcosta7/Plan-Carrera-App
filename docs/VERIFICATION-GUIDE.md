...
* Error tiene contraste AA. Para mejor accesibilidad, usar #dc2626 (5.5:1 AAA)
```
...
**Método: DevTools Chrome**
```
1. Click derecho → Inspeccionar
2. Pestaña Styles
3. Click en color texto
...
1. Actualizar `:root`:
```css
--primary-base: #nuevo-color;
--primary-dark: #más-oscuro;
--primary-light: #más-claro;
```

2. Verificar contraste:
```
Nuevo color sobre #1e293b
Debe ser ≥ 4.5:1
```
...
3. Incluir estilo hover/focus
4. Hacer responsive
5. Documentar en SPECIFICATION.md

### Cambiar Espaciado Global

1. Modificar variable `--spacing-*`
2. Todas las instancias se actualizan automáticamente
3. Verificar responsive en 3 tamaños
